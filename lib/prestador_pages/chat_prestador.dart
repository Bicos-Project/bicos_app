...
class ChatVendedor extends StatefulWidget {
  ...
  const ChatVendedor({super.key, required this.solicitacao});
  ...
  Future<void> _enviarMensagem() async {
    ...
    try {
      await MensagemService.enviar(
        ...
        remetenteId: _userId!,
        tipoRemetente: _perfil ?? 'PRESTADOR',
        texto: texto,
        imagem: image,
      );
      await _carregarMensagens();
      ...
      child: Row(
        children: [
          ...
          CircleAvatar(
            ...
            child: Text(
              widget.solicitacao.clienteNome.isNotEmpty
                  ? widget.solicitacao.clienteNome[0].toUpperCase()
                  : '?',
